...
var Switch = React69.forwardRef((props, ref) => (0, import_jsx_runtime64.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
function NoopTransition({
  ...
  const child = (0, import_react37.cloneElement)(children, {
    ref: combinedRef
  });
...
function useRTGTransitionProps(_ref) {
  ...
  return Object.assign({}, props, {
    ...
    ) : (0, import_react38.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
function ImperativeTransition({
  ...
  const combinedRef = useMergedRefs_default(ref, getChildRef(children));
  return exited && !inProp ? null : (0, import_react39.cloneElement)(children, {
    ref: combinedRef
  });
}
...
var Modal = (0, import_react40.forwardRef)((_ref, ref) => {
  ...
  return (0, import_jsx_runtime72.jsx)(import_jsx_runtime72.Fragment, {
    children: import_react_dom.default.createPortal((0, import_jsx_runtime72.jsxs)(import_jsx_runtime72.Fragment, {
...
var Modal2 = React84.forwardRef(({
  ...
  const renderBackdrop = (0, import_react42.useCallback)((backdropProps) => (0, import_jsx_runtime80.jsx)("div", {
    ...backdropProps,
...
var NavItem = React85.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Nav = React87.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react46.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default2(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react47.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var Offcanvas = React95.forwardRef(({
  ...
  const renderBackdrop = (0, import_react48.useCallback)((backdropProps) => (0, import_jsx_runtime91.jsx)("div", {
    ...backdropProps,
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime108.jsxs)(import_jsx_runtime107.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react55.cloneElement)(children, triggerProps), (0, import_jsx_runtime106.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
function useTabPanel(_ref) {
  ...
  const context6 = (0, import_react57.useContext)(TabContext_default);
    ...
    children: (0, import_jsx_runtime125.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime125.jsx)(Transition, {
        ...
        children: (0, import_jsx_runtime125.jsx)(Component2, {
          ...rest,
          ref,
          className: (0, import_classnames91.default)(className, prefix, isActive && "active")
        })
      })
    })
  });
...
var Table = React122.forwardRef(({
  ...
  const classes = (0, import_classnames92.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size2 && `${decoratedBsPrefix}-${size2}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime127.jsx)(NavItem_default, {
    as: "li",
    role: "presentation",
...
var ToastHeader = React126.forwardRef(({
  ...
  const context6 = (0, import_react59.useContext)(ToastContext_default);
  const handleClick = useEventCallback2((e) => {
